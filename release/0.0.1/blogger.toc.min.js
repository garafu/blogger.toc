...
function P(a){var b,c;b=O();N?(c=N.feed.entry,a=a.feed.entry,c=c.concat(a),N.feed.entry=c):N=a;if(b.a.h<=b.b){for(c=document.getElementById(L);a=c.firstChild;)c.removeChild(a);b.sort(N);b.print(N)}else K(b)}var Q=["garafu","blogger","toc","load"],R=this;Q[0]in R||!R.execScript||R.execScript("var "+Q[0]);for(var S;Q.length&&(S=Q.shift());)Q.length||void 0===P?R=R[S]?R[S]:R[S]={}:R[S]=P;
