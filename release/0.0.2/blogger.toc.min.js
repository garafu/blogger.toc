/** Copyright (c) 2013 akinari tsugo */function f(a){return function(){return a}}function k(a,b){function c(){}c.prototype=b.prototype;a.s=b.prototype;a.prototype=new c};function l(a){this.a=a};function n(a){this.a=a}k(n,l);n.prototype.execute=function(a){a=a.entry||[];var b,c,e,d;b=document.createElement("ul");b.className="poststoc-list";e=0;for(d=a.length;e<d;e++)c=document.createElement("li"),c.appendChild(r(a[e])),c.className="poststoc-item",b.appendChild(c);return b};
...
t.prototype.g=function(){var a=this.a,b=this.c.term,c=document.createElement("div"),e=document.createElement("div"),d=document.createElement("a"),g=document.createElement("ul"),a="http://"+a.j,a=a+"/search/label/",a=a+b;d.appendChild(document.createTextNode(b));d.href=a;d.className="poststoc-category-anchor";e.appendChild(d);e.className="poststoc-category-title";g.className="poststoc-list";c.appendChild(e);c.appendChild(g);c.className="poststoc-category";this.d=c;this.n=e;this.f=g};function u(a){this.a=a}k(u,l);u.prototype.execute=function(a){var b=this.a,c=a.entry||[];a=a.category||[];var e,d,g,C,m,D,p,E,h,q;C={};m=[];D=document.createDocumentFragment();e=0;for(g=c.length;e<g;e++)for(E=c[e],a=E.category||[],d=a.length;d--;)p=a[d],q=new s(b,E),h=C[p.term],h||(h=new t(b,p),C[p.term]=h,m[m.length]=h),p=q.d,h=h.f,q=document.createElement("li"),q.className="poststoc-item",q.appendChild(p),h.appendChild(q);m=this.sort(m);e=0;for(g=m.length;e<g;e++)D.appendChild(m[e].d);return D};
u.prototype.sort=function(a){return a};function v(a){this.a=a}k(v,u);v.prototype.sort=function(a){return a.sort(function(a,c){return a.f.childNodes.length<c.f.childNodes.length?1:-1})};function w(a){this.a=a}w.prototype.e=f("published");w.prototype.execute=function(){};function x(a){this.a=a}k(x,w);x.prototype.e=f("published");x.prototype.execute=function(){};function y(a){this.a=a}k(y,u);y.prototype.sort=function(a){return a.sort(function(a,c){return a.getName()<c.getName()?-1:1})};function z(){var a=window.POSTSTOC_SETTINGS||{};this.q=A(a.loadMessage,"LOAD DATA ...");this.j=A(a.blogURL,"garafu.blogspot.jp");this.h=A(a.maxResults,Infinity);this.style=A(a.style,"");this.l=A(a.orderby,"published");this.m=A(a.printby,"label");this.p=A(a.labelListEnabled,!0);this.t=A(a.updatedDateEnabled,!1);this.r=A(a.publishedDateEnabled,!0)}function A(a,b){return void 0!==a?a:b};function B(a,b,c){var e;B=e=window.addEventListener?function(a,b,c){a.addEventListener(b,c,!1)}:window.attachEvent?function(a,b,c){a.attachEvent("on"+b,c)}:function(a,b,c){a["on"+b]=c};e(a,b,c)};function F(a){this.a=a}k(F,w);F.prototype.e=f("published");F.prototype.execute=function(a){(a.entry||[]).sort(function(a,c){return a.title.$t>c.title.$t?1:-1})};function G(a){this.a=a}k(G,w);G.prototype.e=f("updated");G.prototype.execute=function(){};function H(){this.a=new z;this.i=I(this);this.k=J(this);this.b=0;K(this)}var L="__garafu.blogger.toc__"+(new Date).getTime(),M=null,contract=contract||void 0,N=contract;function O(){var a=M;a||(M=a=new H);return a}
