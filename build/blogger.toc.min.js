...
z.prototype.print=function(a){a=this.h.execute(a.feed||{});var c=document.createElement("div"),b=document.createElement("a");document.createElement("a");document.createElement("a");b.href="https://github.com/garafu/blogger.toc";b.appendChild(document.createTextNode('This page uses "blogger.toc" created by garafu.'));c.appendChild(b);c.style.display="block";c.style.fontSize="small";c.style.margin="20px 0";a.appendChild(c);document.getElementById(C).appendChild(a)};
function A(a){a=a.a;switch(a.i.toLowerCase()){case "published":return new p(a);case "updated":return new y(a);case "title":return new x(a);default:return new p(a)}}s(window,"load",function(){F()});document.write('<div id="'+C+'" class="poststoc">LOAD DATA ...</div>');function G(a){var c,b;c=F();E?(b=E.feed.entry,a=a.feed.entry,b=b.concat(a),E.feed.entry=b):E=a;if(c.a.e<=c.b){for(b=document.getElementById(C);a=b.firstChild;)b.removeChild(a);c.sort(E);c.print(E)}else B(c)}
var H=["garafu","blogger","toc","load"],I=this;H[0]in I||!I.execScript||I.execScript("var "+H[0]);for(var J;H.length&&(J=H.shift());)H.length||void 0===G?I=I[J]?I[J]:I[J]={}:I[J]=G;
