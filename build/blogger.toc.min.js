...
new J(this.published.format,this.locale);this.updated.format=new J(this.updated.format,this.locale);this.newPost.term=new Date((new Date).getTime()-864E5*this.newPost.term)}function M(a,c,b,d){var e;b=b||{};for(e in d)"object"!==typeof d[e]||d[e]instanceof Array?c[e]=void 0!==b[e]?b[e]:d[e]:(c[e]=c[e]||{},M(a,c[e],b[e],d[e]))};function N(a,c,b){var d;N=d=window.addEventListener?function(a,c,b){a.addEventListener(c,b,!1)}:window.attachEvent?function(a,c,b){a.attachEvent("on"+c,b)}:function(a,c,b){a["on"+c]=b};d(a,c,b)};function O(a){this.a=a}m(O,C);O.prototype.i=l("published");O.prototype.execute=function(a){switch((this.a.sort.order||"").toLocaleLowerCase()){case "asc":this.e(a);break;case "desc":this.c(a);break;default:this.e(a)}};O.prototype.e=function(a){(a.entry||[]).sort(function(a,b){return a.title.$t>b.title.$t?1:-1})};O.prototype.c=function(a){(a.entry||[]).sort(function(a,b){return a.title.$t<b.title.$t?1:-1})};function P(a){this.a=a}m(P,C);P.prototype.i=l("updated");P.prototype.execute=function(a){switch((this.a.sort.order||"").toLocaleLowerCase()){case "asc":this.e(a);break;case "desc":this.c(a);break;default:this.c(a)}};P.prototype.e=function(a){(a.entry||[]).sort(function(a,b){return a.updated.$t>b.updated.$t?1:-1})};P.prototype.c=function(){};function Q(){this.a=new L;this.t=R(this);this.v=aa(this);this.d=0;S(this)}var T="__garafu.blogger.toc__"+(new Date).getTime(),U=null,contract=contract||void 0,V=contract;function W(){var a=U;a||(U=a=new Q);return a}
