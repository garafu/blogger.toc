...
function S(a){var c;c=a.a.m;var b=a.a,d=a.t,b="//"+b.blogURL,b=b+"/feeds/posts/summary?",b=b+"redirect=false&",b=b+("start-index="+(a.d+1)+"&"),b=b+("max-results="+(a.d+c<a.a.maxResults?a.d+c:a.a.maxResults-a.d)+"&"),b=b+("orderby="+d.i()+"&"),b=b+"alt=json-in-script&",b=b+"callback=";a=b+="garafu.blogger.toc.load";c=document.createElement("script");c.src=a;c.type="text/javascript";document.body.appendChild(c)}Q.prototype.sort=function(a){this.t.execute(a.feed||{})};
